...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `203` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
...
[MatchZy](https://github.com/shobhit-pathak/MatchZy) | `0.7.2` | MatchZy is a plugin for CS2 for running and managing practice/pugs/scrims/matches with easy configuration!
[Map_Configs_Prefix](https://github.com/oqyh/cs2-Map-Configs-Prefix/)| `1.0.5` | Allows you to quick and easily create unique configuration files for each map on your server.
...
[CS2 BombAnnouncer](https://github.com/audiomaster99/CS2BombsiteAnnouncer)| `Build 20` | Graphical Bombsite Announcer using Center HUD image capability.
