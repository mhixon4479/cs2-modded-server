...
[Deathmatch](https://github.com/NockyCZ/CS2-Deathmatch) | `1.1.4` | [NockyCZ](https://github.com/NockyCZ/) | Custom Deathmatch plugin (Includes custom spawnpoints, multicfg, gun selection, spawn protection, etc)
